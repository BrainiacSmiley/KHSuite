  ...
  I18n.available_locales.each do |locale|
    ...
    describe "PUT 'update'" do
      ...
      describe "for an authorized user" do
        ...
        describe "failure" do
          ...
          it "should render the right page 'users/show'" do
            response.should render_template('users/show')
          end
    ...
    describe "DELETE 'destroy'" do
      ...
      describe "for an admin user authorized user" do
        ...
        it "should destroy the micropost from other user" do
          lambda do
            delete :destroy, :id => @doctor
          end.should change(Doctor, :count).by(-1)
        end
    ...
    describe "POST 'creature'" do
      ...
      describe "failure" do
        ...
        it "should render the 'users/show' page" do
          post :create, :doctor => @attr
          response.should render_template('users/show')
        end
      end
      ...
      describe "success" do
        ...
        it "should render the 'user_path(@user)' page" do
          post :create, :doctor => @attr
